    ...
    <Fragment>
      <div className="card shadow-lg mb-4">
        ...
        <div className="card-body">
          <ul>
            <li><strong>Renewal Reminder:</strong> Check your policy renewal date and enable calendar alerts so you don't miss renewals.</li>
            <li><strong>Claim Process:</strong> Keep copies of receipts and policy documents; file claims promptly with accurate details.</li>
            <li><strong>Discounts:</strong> Ask your provider about multi-policy or no-claim discounts to reduce premiums.</li>
            <li><strong>Support:</strong> For help, contact your insurer's customer support (phone or email) listed on your policy documents.</li>
          </ul>
        </div>
      </div>
